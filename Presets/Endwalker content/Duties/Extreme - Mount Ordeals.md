...
[International] Triangular Spread / 分散火流
```
...
[International] Tornado Spread / 火燕流（分散）
```
...
[International] Charge Line/ 分身直綫
```
...
[International] Fire Spread  / 重炎分散
```
...
## Obsolete/untested section (to be removed?)
