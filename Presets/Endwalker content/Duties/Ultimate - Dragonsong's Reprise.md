...
```
Nidhogg Marker: Displays a red circle around Nidhogg during Dives that shows you where to place your Dives.
```
...
```
Gnash Marker: Displays a red circle with a faint red danger zone when Gnash (Out) is being performed by Nidhogg.
```
...
```
Lash Marker: Displays a red circle with faint red outer circles when Lash (In) is being performed by Nidhogg.
```
...
Wrath of the Heavens: display tethers (make tethers same as red line) and safe spot for blue marker (**WIP, not precise yet**)
```
...
Wrath of the heavens: display safespot under Ser Grinnaux
```
...
Weath of the heavens: display chain lightning radius around people. Whether it is precise - needs to be confirmed yet.
```
